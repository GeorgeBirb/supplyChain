...
contract SupplyChain {
   ...
   string public descriptionToUpdate;
    ...
    function addCandidate(address _address,bool _isTheOwner,uint _chainNo) public{
        candidatesCount = candidatesCount + 1;
        candidates[candidatesCount] = Candidate(candidatesCount, _address, _chainNo, _isTheOwner);
    }

    function addTransferShipment(address _origin,address _destination,string memory _product,uint _amount,string memory _departureDate,string memory _arrivalDate,string memory _description) public{
    ...
    function transfer (uint _candidateId) public {
        ...
        function addMultipleProducts() public {
